...
const FIELD_LABELS: Record<string, string> = {
  ...
  "computer.enabled": "Computer Control Enabled",
  "computer.exec.path": "Computer Exec Python Path",
  "computer.exec.args": "Computer Exec Python Args",
  "computer.exec.timeoutMs": "Computer Exec Timeout (ms)",
  "computer.vision.path": "Computer Vision Python Path",
  "computer.vision.args": "Computer Vision Python Args",
  "computer.vision.timeoutMs": "Computer Vision Timeout (ms)",
  "computer.vision.ocrMatchThreshold": "Computer OCR Match Threshold",
  "computer.vision.ocrWaitTimeoutMs": "Computer OCR Wait Timeout (ms)",
  "computer.vision.modelName": "Computer Vision Model Name",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "computer.enabled": "Enable OS-level computer control tooling (requires Python sidecars).",
  "computer.exec.path": "Python executable for computer execution sidecar (default: python3).",
  "computer.exec.args": "Extra args passed to the computer execution python process.",
  "computer.exec.timeoutMs": "Timeout in ms for computer execution RPC calls.",
  "computer.vision.path": "Python executable for OCR/vision grounding sidecar (default: python3).",
  "computer.vision.args": "Extra args passed to the OCR/vision python process.",
  "computer.vision.timeoutMs": "Timeout in ms for OCR/vision RPC calls.",
  "computer.vision.ocrMatchThreshold": "Fuzzy match threshold for OCR text (0-1).",
  "computer.vision.ocrWaitTimeoutMs":
    "How long to wait for proactive OCR before running on-demand OCR.",
  "computer.vision.modelName": "Vision model name for grounding (InternVL-compatible).",
  "diagnostics.flags":
